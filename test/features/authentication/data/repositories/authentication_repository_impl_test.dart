...
@GenerateMocks(
    [AuthenticationDataSource, DomainUser, UserCredential, DomainUserConverter])
void main() {
    ...
    test('Signing in with the provided email and password should succeed',
        (() async {
          when(mockDomainUserConverter.fromUserCredential(
              userCredential: mockUserCredential)).thenReturn(mockDomainUser);

          authenticationRepository = AuthenticationRepositoryImpl(
              authenticationDataSource: mockAuthenticationDataSource, domainUserConverter: mockDomainUserConverter);
