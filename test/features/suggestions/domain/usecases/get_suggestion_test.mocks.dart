...
// in home_activity_suggestions/test/features/suggestions/domain/usecases/get_suggestion_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSuccess<T> extends _i1.Mock implements _i6.Success<T> {
  MockSuccess() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockFailure<T> extends _i1.Mock implements _i6.Failure<T> {
  MockFailure() {
    _i1.throwOnMissingStub(this);
  }
